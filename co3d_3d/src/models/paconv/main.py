...
from util.util import IOStream, cal_loss, load_cfg_from_cfg_file, merge_cfg_from_list
...
def train(args, io):
    train_loader = DataLoader(
        ModelNet40(partition="train", num_points=args.num_points, pt_norm=args.pt_norm),
    ...
    test_loader = DataLoader(
        ModelNet40(partition="test", num_points=args.num_points, pt_norm=False),
        num_workers=args.workers,
